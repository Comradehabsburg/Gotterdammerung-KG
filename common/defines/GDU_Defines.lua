...
NDefines.NGame.AIR_LOG_TIMEOUT_HOURS = 12						-- Vanilla was 24
NDefines.NResistance.GARRISON_LOG_MAX_MONTHS = 0

NDefines.NNavy.NAVAL_COMBAT_RESULT_TIMEOUT_YEARS = 0.1							-- after that many years, we clear the naval combat results, so they don't get stuck forever in the memory.
NDefines.NNavy.CONVOY_LOSS_HISTORY_TIMEOUT_MONTHS = 0						-- after this many months remove the history of lost convoys to not bloat savegames and memory since there is no way to see them anyway
...
NDefines.NCountry.AIR_SUPPLY_CONVERSION_SCALE = 0.05 -- original 0.05 air supply?
...
NDefines.NProduction.BASE_FACTORY_SPEED_NAV = 2.125 				-- vanilla was 2.5 --- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NDefines.NAir.COMBAT_DAMAGE_SCALE_CARRIER = 2.5
...
NDefines.NAir.DISRUPTION_FACTOR_CARRIER = 14.0							-- multiplier on disruption damage to scale its effects on carrier vs carrier planes
...
NDefines.NNavy.ENEMY_AIR_SUPERIORITY_IMPACT = -0.75           		-- effect on ship efficiency due to enemy air superiorty
...
NDefines.NNavy.AMPHIBIOUS_LANDING_PENALTY = -0.45								-- amphibious landing penalty
